...
import { createStaticInterface } from "./static-interface";
...
// SERVEUR RAUN-RACHID DIRECT - SOLUTION FINALE
...
// Interface RAUN-RACHID complète
app.get('*', (req, res) => {
  const capsules = [
    {
      id: 1,
        ...
        function selectCapsule(id) {
            ...
            if (capsule) {
                document.querySelector('.main-content').innerHTML = \\\`
                    <div class="welcome-message">
                        <h1 class="welcome-title">\\\${capsule.titre}</h1>
                        ...
                        <button onclick="showAccueil()" style="background: transparent; border: 1px solid #00ff00; color: #00ff00; padding: 0.8rem 2rem; cursor: pointer; font-family: 'Courier New', monospace;">
...
app.listen(port, "0.0.0.0", () => {
  console.log(\`🔥 INTERFACE RAUN-RACHID FINALE: http://localhost:\${port}\`);
});
